...
export class migrations21591742968079 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "repetitions" ALTER COLUMN "subject_id" DROP NOT NULL`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "repetitions" DROP CONSTRAINT "FK_ca7f75b112375e00d3aed45293e"`);
        await queryRunner.query(`ALTER TABLE "observations" ALTER COLUMN "updated_at" SET DEFAULT '2020-06-09 16:58:31.825614'`);
        await queryRunner.query(`ALTER TABLE "observations" ALTER COLUMN "created_at" SET DEFAULT '2020-06-09 16:58:31.825614'`);
        await queryRunner.query(`ALTER TABLE "observation_type" ALTER COLUMN "updated_at" SET DEFAULT '2020-06-09 16:58:31.825614'`);
        await queryRunner.query(`ALTER TABLE "observation_type" ALTER COLUMN "created_at" SET DEFAULT '2020-06-09 16:58:31.825614'`);
        await queryRunner.query(`ALTER TABLE "repetitions" ALTER COLUMN "updated_at" SET DEFAULT '2020-06-09 16:58:31.825614'`);
        await queryRunner.query(`ALTER TABLE "repetitions" ALTER COLUMN "created_at" SET DEFAULT '2020-06-09 16:58:31.825614'`);
        await queryRunner.query(`ALTER TABLE "repetitions" ALTER COLUMN "subject_id" SET NOT NULL`);
        await queryRunner.query(`ALTER TABLE "repetitions" ADD CONSTRAINT "FK_ca7f75b112375e00d3aed45293e" FOREIGN KEY ("subject_id") REFERENCES "subjects"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "subjects" ALTER COLUMN "updated_at" SET DEFAULT '2020-06-09 16:58:31.825614'`);
        await queryRunner.query(`ALTER TABLE "subjects" ALTER COLUMN "created_at" SET DEFAULT '2020-06-09 16:58:31.825614'`);
