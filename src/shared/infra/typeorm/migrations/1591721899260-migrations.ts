...
export class migrations1591721899260 implements MigrationInterface {
  name = 'migrations1591721899260';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TABLE "observations" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "comment" character varying, "value" character varying, "created_at" TIMESTAMP NOT NULL DEFAULT 'now()', "updated_at" TIMESTAMP NOT NULL DEFAULT 'now()', "type_id" uuid, "submission_id" uuid, "user_id" character varying, CONSTRAINT "PK_f9208d64f50a76030758087c0ef" PRIMARY KEY ("id"))`
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "observations" ADD CONSTRAINT "FK_5bb580c8faaf9b445694561f5d5" FOREIGN KEY ("type_id") REFERENCES "observation_type"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`
    );
    await queryRunner.query(
      `ALTER TABLE "observations" ADD CONSTRAINT "FK_fe778909430fa63afac1387abe2" FOREIGN KEY ("submission_id") REFERENCES "submissions"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`
    );
  }

  public async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `ALTER TABLE "observations" DROP CONSTRAINT "FK_fe778909430fa63afac1387abe2"`
    );
    await queryRunner.query(
      `ALTER TABLE "observations" DROP CONSTRAINT "FK_5bb580c8faaf9b445694561f5d5"`
    );
    await queryRunner.query(
